...
exports.handleSaleCommand = handleSaleCommand;
...
async function handleSaleCommand(interaction) {
    ...
    try {
        ...
        const message = await interaction.editReply({ content: '', embeds: [embed], components });
        if (totalPages <= 1)
            return;
...
//# sourceMappingURL=steamSaleHandler.js.map