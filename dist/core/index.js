...
exports.gracefulDegradation = exports.registerDefaultChecks = exports.startHealthServer = exports.setHealthStatus = exports.getHealthStatus = exports.runHealthChecks = exports.registerHealthCheck = exports.health = exports.isSentryEnabled = exports.closeSentry = exports.flushSentry = exports.startTransaction = exports.addBreadcrumb = exports.clearSentryUser = exports.setSentryUser = exports.captureMessage = exports.captureException = exports.initializeSentry = exports.sentry = exports.registerErrorShutdownHandler = exports.interactionErrorBoundary = exports.withTimeout = exports.withErrorHandling = exports.safeAsync = exports.initializeErrorHandlers = exports.getIsShuttingDown = exports.initializeShutdownHandlers = exports.handleShutdown = exports.registerShutdownHandler = exports.BOOTSTRAP_CONFIG = exports.bootstrapHealthCheck = exports.bootstrap = exports.CLIENT_OPTIONS = exports.ActivityType = exports.getClientStats = exports.setPresence = exports.createClient = exports.CIRCUIT_CONFIGS = exports.CircuitBreakerRegistry = exports.circuitBreakerRegistry = exports.CircuitState = exports.CircuitBreaker = exports.isErrorCategory = exports.getErrorMessage = exports.ErrorCodes = exports.Result = exports.LOG_CHANNEL_ID = exports.LOG_LEVELS = exports.Logger = exports.logger = void 0;
exports.ServiceState = exports.DegradationLevel = exports.GracefulDegradation = exports.gracefulDegradationInstance = void 0;
/**
 * Core Module Index
...
Object.defineProperty(exports, "registerErrorShutdownHandler", { enumerable: true, get: function () { return errorHandler_1.registerShutdownHandler; } });
// Sentry
