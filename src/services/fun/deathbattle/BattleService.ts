...
class BattleService {
     ...
     */
    removeBattle(guildId: string): void {
     ...
     */
    dealDamage(battle: Battle, isPlayer1Turn: boolean): string {
        ...
        if (!power) {
            ...
            [damage, log] = this.processPower(
                power, attacker, defender, battle,
                defenderHp, attackerMaxHp, defenderMaxHp,
                debuff, totalBoost, atkEff, defEff, isPlayer1Turn
            );
        }
